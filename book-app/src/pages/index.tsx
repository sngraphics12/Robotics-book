    ...
    <header className={styles.hero}>
      <div className={styles.heroInner}>
        ...
        <p className={styles.heroSubtitle}>
         Learn humanoid robotics from theory to full-scale operation using ROS 2, Gazebo, Unity, NVIDIA Isaac, and Vision-Language-Action models.
        </p>
      ...
      <div className={styles.container}>
        <div className={styles.footerGrid}>
          ...
          <div className={styles.footerColumn}>
            <h4>Resources</h4>
            <ul>
              <li><Link to="https://github.com/sngraphics12">GitHub</Link></li>
             
            
            </ul>
          </div>
          <div className={styles.footerColumn} style={{color:'white'}}>
            <h4>Technologies</h4>
            <ul>
